...
# {
#   "Name": "set_site_sharing_capability",
#   "Description": "Set the external sharing capability for a site.",
#   "Fields": [
#     { "Name": "SiteUrl", "Type": "string", "Required": true, "Order": 1, "Arg": "-SiteUrl" },
#     { "Name": "SharingCapability", "Type": "string", "Required": true, "Order": 2, "Arg": "-SharingCapability", "Choices": ["Disabled", "ExistingExternalUserSharingOnly", "ExternalUserSharingOnly", "ExternalUserAndGuestSharing"] }
#   ]
# }
# OMAKURE_SCHEMA_END
